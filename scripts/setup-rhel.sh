...
curl -o /home/rhel/mod1.sh -L ${GITHUB_BASE_URL}/scripts/module-01-01-solve.sh
curl -o /home/rhel/mod2.sh -L ${GITHUB_BASE_URL}/scripts/module-01-02-solve.sh
curl -o /home/rhel/mod3.sh -L ${GITHUB_BASE_URL}/scripts/module-01-03-solve.sh
