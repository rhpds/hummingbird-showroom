...
Multi-stage builds create new images for each set of steps, delimited by a new `FROM` directive, effectively creating a scripted build in a single Containerfile.
