...
The JSON will have information about checksums, packages, publishers and more. Our SBOMs are useful to understand the contents of the base, but you'll likely want to publish SBOMs that include your application and any of it's dependencies as well.
Let's explore how to do that with `syft`.
