...
[NOTE]
====
Throughout this lab, you'll see files marked with circled numbers and a numbered list following the file. These are to help draw your attention to particular parrts of the file. These are part of the source file and also visible in the terminal via `cat` or `vi`. The numbers will not be included if you copy from one of the blocks.
====
