...
[source,bash,role=execute]
----
curl -LO https://raw.githubusercontent.com/Red-Hat-SE-RTO/hummingbird-labs/main/content/modules/ROOT/assets/attachments/setup-rhel-developer.sh
...
==== Step 14a: Install Podman Desktop on RHEL 9 (Flatpak)
...
==== Step 14b: Install Podman Desktop on RHEL 10 (dnf)
...
[NOTE]
====
If the extensions repository is not available in your subscription, fall back to Flatpak as shown in Step 14a above.
====

==== Step 15: Launch Podman Desktop
