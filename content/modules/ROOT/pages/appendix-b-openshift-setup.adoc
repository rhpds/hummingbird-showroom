...
Your Gitea environment is ready. Proceed to xref:module-02-08-renovate-podman.adoc[Sub-Module 2.8: Automated Dependency Updates with Renovate + Podman] and select the **Gitea** tab at each step.
