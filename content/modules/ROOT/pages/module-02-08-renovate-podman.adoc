...
----
oc login --server={openshift_api_server_url}
----
  ...
  "packageRules": [
    {
      ...
      "matchPackagePatterns": ["registry.access.redhat.com/hi/.*"],
      ...
      spec:
        ...
        params:
          ...
          - name: runtime-registry
            value: "registry.access.redhat.com/hi"
          - name: promote-image
...
LATEST_DIGEST=$(skopeo inspect \
  docker://registry.access.redhat.com/hi/nodejs-20:latest \
  | jq -r '.Digest')
