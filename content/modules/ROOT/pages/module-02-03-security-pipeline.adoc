...
[NOTE]
====
The Quay API requires authentication for private repositories. If the API calls below return `401 Unauthorized`, you can view Clair scan results directly in the Quay console at `+https://{workshop-registry}/repository/{registry-user}/secure-nodejs+` under the **Security Scan** tab.
====
...
oc create secret docker-registry registry-credentials \
    --docker-server="{workshop-registry}" \
