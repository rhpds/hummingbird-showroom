...
You can also view the results in the Quay web console:

. Open {workshop-registry-console} in your browser
. Navigate to *{registry-user}/secure-nodejs* -> *Tags*
. The *Security Scan* column shows the vulnerability count for each tag
