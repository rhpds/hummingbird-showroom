...
[source,bash,role=execute]
----
oc get pipelinerun generate-nodejs-policy -w
----
...
[source,bash,role=execute]
----
oc get pipelinerun generate-nodejs-policy \
...
[source,bash,role=execute]
----
oc logs generate-nodejs-policy-generate-policy-pod -c step-generate-policy
----
