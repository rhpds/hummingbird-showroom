...
Generate a policy for the Node.js application built in Sub-Module 2.1:
...
[TIP]
====
If pods fail with `SELinux type not found`, the CIL policy hasn't been loaded on the node yet. In a workshop environment, this is expected -- the MachineConfig step below shows how production clusters handle this.
====
...
You've finished both modules of the Project Hummingbird Environment Workshop!
...
Thank you for completing the **Project Hummingbird Environment Workshop**!
