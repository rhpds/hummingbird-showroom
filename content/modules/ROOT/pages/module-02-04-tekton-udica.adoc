...
----
oc get task udica-policy-generate -n {user}-hummingbird-builds
----
...
[source,bash,role=execute,subs=attributes]
----
oc get pipeline selinux-policy-pipeline -n {user}-hummingbird-builds
----
...
[source,bash,role=execute,subs=attributes]
----
oc get pipelinerun generate-nodejs-policy -n {user}-hummingbird-builds -w
----
...
[source,bash,role=execute,subs=attributes]
----
TASKRUN=$(oc get pipelinerun generate-nodejs-policy -n {user}-hummingbird-builds \
  -o jsonpath='{.status.childReferences[0].name}')
oc get taskrun $TASKRUN -n {user}-hummingbird-builds \
...
[source,bash,role=execute,subs=attributes]
----
oc logs ${TASKRUN}-pod -n {user}-hummingbird-builds -c step-generate-policy
----
...
[source,bash,role=execute,subs=attributes]
----
oc get pods -l tekton.dev/pipelineRun=generate-nodejs-policy -n {user}-hummingbird-builds
----
====
...
[source,bash,role=execute,subs=attributes]
----
oc adm policy add-scc-to-user privileged -z default -n {user}-hummingbird-builds
----
...
[source,bash,role=execute,subs=attributes]
----
oc get pods -l app=nodejs-selinux -n {user}-hummingbird-builds
----
...
[source,bash,role=execute,subs=attributes]
----
oc delete deployment nodejs-selinux -n {user}-hummingbird-builds
----
====
