...
Switch to the RHACS Central dashboard tab on the right.

[TIP]
====
Click the {rhacs_route}[{rhacs_route}^] link to open the RHACS Central dashboard in a separate window if you would like a separate window.
====
