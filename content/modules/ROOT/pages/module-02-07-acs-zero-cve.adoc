...
User name:
        anonymous bearer token "{user}" with roles [Analyst] (jti: 6cfeaeed-6052-46a1-86d4-998132a186fb, expires: 2026-05-08T09:29:05Z)
Roles:
        - Analyst
Access:
        r- Access
...
[source,bash,role=execute,subs="attributes"]
----
echo "export ACS_ROUTE={rhacs_route}" >>$HOME/.bashrc
echo "export ACS_USER={rhacs_username}" >>$HOME/.bashrc
echo "export ACS_PASSWORD={password}" >>$HOME/.bashrc
source $HOME/.bashrc

echo "ACS Dashboard: ${ACS_ROUTE}"
echo "Username:      ${ACS_USER}"
...
. Select *Login with username/password* and log in with username and password shown above
