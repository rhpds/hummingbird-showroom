...
[NOTE]
====
Security scanning tools have been pre-installed in this environment:

* cosign {cosign-version} - For image signing and verification
* syft {syft-version} - For SBOM generation  
* grype {grype-version} - For vulnerability scanning (database pre-updated)
