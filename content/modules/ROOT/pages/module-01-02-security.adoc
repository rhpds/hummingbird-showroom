...
We'll compare the multi-stage image you just created to a pre-built UBI version of the same Quarkus application. This UBI image was built in a single stage and will include additional OS and build tools.
[source,bash,role=execute]
----
