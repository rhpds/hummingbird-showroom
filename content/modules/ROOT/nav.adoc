...
* Optional Exercises
** xref:module-02-05-chunkah-pipeline.adoc[chunkah in CI/CD Pipelines]
** xref:module-02-06-rhtas.adoc[Keyless Signing with RHTAS]
** xref:module-02-08-renovate-podman.adoc[Automated Dependency Updates with Renovate + Podman]
